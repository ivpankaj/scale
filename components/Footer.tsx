...
export function Footer({ handleQuickGuideClick, handleKnowMoreClick }: { handleQuickGuideClick: () => void; handleKnowMoreClick: () => void }) {
  return (
    <div className="flex justify-end">
      <nav className="fixed bottom-0 left-0 right-0 z-50 p-2">
        <button    onClick={handleQuickGuideClick} className="container mx-auto flex justify-between items-center">
          <motion.button
