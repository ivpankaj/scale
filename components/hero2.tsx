  ...
  return (
    <AnimatedSection>
      ...
      <div className="min-h-screen flex flex-col items-center justify-center relative px-6 md:px-10 lg:px-16">
        ...
        <button
          className="block w-full px-4 py-2 border mt-1 bg-[#ff9800] hover:bg-[rgba(255,151,16,0.79)] text-white hover:text-gray-200 rounded-[10px] shadow-md focus:outline-none focus:ring-2"
