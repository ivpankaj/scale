      ...
      <div className="min-h-screen flex flex-col items-center justify-center relative px-4">
        ...
        >
          ...
          <motion.div
            ...
            transition={{ delay: 0.6 }}
          >
            <button className="md:w-[300px] sm:w-[100px] bg-[#ff9800] backdrop-blur-sm border border-gray-600 rounded-lg p-4 text-lg text-white transition-colors">
              Get Rs 200 Discount
            </button>
          </motion.div>
          ...
          <motion.div
            ...
            transition={{ delay: 0.6 }}
          >
            <button className="md:w-[300px] sm:w-[180px] bg-[#ff9800] backdrop-blur-sm border border-gray-600 rounded-lg p-4 text-lg text-white transition-colors">
              Talk to an Expert
            </button>
          </motion.div>
        </motion.div>
